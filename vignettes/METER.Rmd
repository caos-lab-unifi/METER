...
# METER tutorial {.unnumbered}

METER (METhylation analyzER) is a computational tool to analyze TC exploiting iDMS and iDMR in lpWGBS data of cfDNA samples. It comprises three modules:
...
path_out <- '/home/dario.romagnoli/METER/toy_out/create_read_table_noDMR/'
...
example_table <- readRDS(file.path(path_out, 'samp1.rds'))
head(example_table)
```

### filter_cov_alpha100 {.unnumbered}
...
```{r}
path_read_tables <- path_out
path_cpg_files <- '/home/marta.paoli/packages/METER/data/Bismark/'
path_bismark <- '/home/marta.paoli/bismark/Bismark-0.23.1/bismark2bedGraph'
filter_cov_out_folder <- '/home/dario.romagnoli/METER/toy_out/filter_cov_alpha100/'
dir.create(filter_cov_out_folder, showWarnings = F, recursive = T)
...
parallel::mclapply(read_tables, function(i){
  ...
  filter_cov_alpha100(path_bismark2bedGraph = path_bismark, path_cpg_file = path_cpg, path_read_table = i, path_out = filter_cov_out_folder, remove_cpg = F)

}, mc.cores = 1)

```

### create_dms_beta_table {.unnumbered}
...
```{r}
path_cov_files <- '/home/dario.romagnoli/METER/toy_out/filter_cov_alpha100/'
path_dmss <- '/home/marta.paoli/packages/METER/data/dmr_dms_tables/dms_filtered.rds'
path_out <- '/home/dario.romagnoli/METER/toy_out/'
...
```{r}
path_dmss <- '/home/marta.paoli/packages/METER/data/dmr_dms_tables/dms_filtered.rds'
path_dms_beta <- '/home/dario.romagnoli/METER/toy_out/dms_beta.rds'
path_out <- '/home/dario.romagnoli/METER/toy_out/'
...
path_out <- '/home/dario.romagnoli/METER/toy_out/create_read_table/'
...
### take a look to one of the tables created
example_table <- readRDS('/home/dario.romagnoli/METER/toy_out/create_read_table/samp1.rds')
head(example_table)

```

### meter_detect_PTR {.unnumbered}
...
```{r}
path_read_tabs <- '/home/dario.romagnoli//METER/toy_out/create_read_table/'
path_out <- '/home/dario.romagnoli//METER/toy_out/'
...
### classify samples
ptr_tab$meter_detected <- ptr_tab$ptr_all>=thr
...
path_dmr_beta <- '/home/dario.romagnoli//METER/toy_out/dmr_beta_subtype.rds'
path_out <- '/home/dario.romagnoli//METER/toy_out/'
