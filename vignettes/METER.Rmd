...
```{r}
path_dmss='/projects/packages/METER/data/dmr_dms_tables/dms_filtered.rds'
path_dms_beta='/projects/packages/METER/toy_out/data_processing/dms_beta.rds'
path_out='/projects/packages/METER/toy_out/METER_quant'
...
pts_tab=create_pts_table(dms_table = dmss, beta_table = dms_beta)
...
# path_cpg_files='/projects/packages/METER/data/bismark/'
# path_out='/projects/packages/METER/toy_out/data_processing/create_read_dmr_table/'
#
...
#
#   read_table=create_read_dmr_table(cpg_file = i)
#
...
example_table=readRDS('/projects/packages/METER/toy_out/data_processing/create_read_dmr_table/MS05_T1.rds')
head(example_table)
...
```{r}
path_read_tables='/projects/packages/METER/toy_out/data_processing/create_read_dmr_table/'
path_cpg_files='/projects/packages/METER/data/bismark/'
path_bis='/home/marta.paoli/bismark/Bismark-0.23.1/bismark2bedGraph'
out_folder='/projects/packages/METER/toy_out/data_processing/filter_cov_alpha100/'

dir.create(out_folder, showWarnings = F, recursive = T)

### CpG files (output of bismark methylation extractor --comprehensive)
cpg_files=list.files(path_cpg_files, full.names = T, pattern = '^CpG_context*')
...
```{r}
path_cov_files='/projects/packages/METER/toy_out/data_processing/filter_cov_alpha100/'
path_dmss='/projects/packages/METER/data/dmr_dms_tables/dms_filtered.rds'
path_out='/projects/packages/METER/toy_out/data_processing/'
...
```{r}
path_read_tabs='/projects/packages/METER/toy_out/data_processing/create_read_dmr_table_v2/'
path_out='/projects/packages/METER/toy_out/METER_detect'

dir.create(path_out, showWarnings = F)

ptr_tab=create_ptr_table(path_read_tables = path_read_tabs, min_sites = 6, ncores = 4)
...
# path_cpg_files='/projects/packages/METER/data/bismark/'
# path_dmrs='/projects/packages/METER/data/dmr_dms_tables/dmr_filtered.rds'
# path_out='/projects/packages/METER/toy_out/data_processing/create_read_dmr_table_v2/'
#
# dir.create(path_out, showWarnings = F, recursive = T)
#
# cpg_files=list.files(path_cpg_files, full.names = T, pattern = 'CpG_context')
...
### take a look to one of the tables created
example_table=readRDS('/projects/packages/METER/toy_out/data_processing/create_read_dmr_table_v2/MS05_T1.rds')
head(example_table)
...
```{r}
path_cov_files='/projects/packages/METER/data/bismark/'
path_dmrs='/projects/packages/METER/data/dmr_dms_tables/dmr_filtered_subtype.rds'
path_out='/projects/packages/METER/toy_out/data_processing/'
...
```{r}
path_median_ref='/projects/packages/METER/data/erpos_erneg_ref.rds'
path_dmr_beta='/projects/packages/METER/toy_out/data_processing/dmr_beta_subtype.rds'
path_out='/projects/packages/METER/toy_out/METER_subtype/'
